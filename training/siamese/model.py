...
from training.siamese.network import LSTMSiameseNetwork, TransformerNetwork
...
class Model:
    ...
    def fit(self, epochs: int, train_set: DataLoader, val_set: DataLoader, shuffle_dataset, patience: int = 20, run_name: str = None):
        ...
        for epoch in range(epochs):
            ...
            if early_stopping.early_stop:
                ...
                break
            # Shuffle dataset indexes to shuffle dataset_couples
            shuffle_dataset()
        end_whole.record()
        torch.cuda.synchronize(DEVICE)
